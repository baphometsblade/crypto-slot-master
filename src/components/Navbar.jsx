...
const Navbar = () => {
  return (
    <Flex as="nav" align="center" justify="space-between" wrap="wrap" padding="1rem" bg="brand.900" color="white" boxShadow="0px 4px 10px rgba(0,0,0,0.5)" _hover={{ bg: "brand.700", transform: "scale(1.1)" }}>
