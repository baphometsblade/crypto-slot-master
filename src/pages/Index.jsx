...
const Index = () => {
  ...
  return (
    <Box p={[4, 8]} bg="gray.900" minHeight="100vh" boxShadow="2xl" bgImage="url('/images/index-background.jpg')" bgSize="cover" bgPosition="center" transition="background 0.5s ease-in-out">
